...
(function() {
  ...
  // @module render
  // @see Renderer
  var Renderer, dirname, fs, jade, render, resolve;
  ...
  Renderer = class Renderer {
    ...
    _renderOne(jade_options, template, output) {
      ...
      return jade.renderFile(`${this.templates_dir}/${template}.jade`, jade_options, (error, result) => {
        var output_file;
        if (error) {
    ...
    _renderGuides() {
      ...
      return this.result.guides.forEach((guide) => {
        ...
        return this._renderOne(jade_options, 'extra', guide.filename);
      });
    }
    ...
    _renderClasses() {
      ...
      return this.result.classes.forEach((klass) => {
        ...
        return this._renderOne(jade_options, 'class', klass.filename);
      });
    }
    ...
    _renderModules() {
      ...
      return this.result.modules.forEach((module) => {
        ...
        return this._renderOne(jade_options, 'module', module.filename);
      });
    }
    ...
    _renderFeatures() {
      ...
      return this.result.features.forEach((feature) => {
        ...
        return this._renderOne(jade_options, 'feature', feature.filename);
      });
    }
    ...
    _renderFiles() {
      ...
      return this.result.files.forEach((file) => {
        ...
        return this._renderOne(jade_options, 'file', file.filename);
      });
    }
