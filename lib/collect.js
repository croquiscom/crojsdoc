...
(function() {
  ...
  Collector = (function() {
    ...
    Collector.prototype.run = function() {
      var all_comments, content, file_count_read;
      file_count_read = 0;
      all_comments = [];
      ...
      try {
        content = fs.readFileSync("" + (this.options.readme || this.options.project_dir) + "/README.md", 'utf-8');
        this.result.readme = markdown(content);
      } catch (_error) {}
