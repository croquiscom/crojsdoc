...
(function() {
  var Collector, collect, dox, is_test_mode, markdown;
  ...
  Collector = (function() {
    ...
    Collector.prototype.processComments = function(comments) {
      return comments.forEach((function(_this) {
        return function(comment) {
          var class_comment, class_name, desc, i, str, tag, type, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7;
    ...
    Collector.prototype.refineResult = function() {
      ...
      result.classes.forEach(function(klass) {
        return klass.properties.sort(function(a, b) {
