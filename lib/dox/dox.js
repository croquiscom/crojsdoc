...
(function() {
  ...
  exports.parseTag = function(str) {
    var getMultilineDescription, lines, parts, tag, type, typeString;
    tag = {};
    lines = str.split('\n');
    ...
    switch (type) {
      ...
      case 'template':
      case 'param':
        typeString = /{.*}/.test(parts[0]) ? parts.shift() : '';
  ...
  exports.parseTagTypes = function(str, tag) {
    var Builder, Parser, ref, result, transform, types;
    ref = require('jsdoctypeparser'), Parser = ref.Parser, Builder = ref.Builder;
